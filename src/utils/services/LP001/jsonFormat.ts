export interface LP001ItemDefinition {
    code: string;
    description: string;
    dataType: string;
    required: boolean;
...
export const LP001_ITEM_DEFINITIONS: LP001ItemDefinition[] = [
...
export const LP001Format = (
    returnKey: string = "LOAN_CLA&PROV_LP001",
