...
export function OL001ExcelView({
    initialData,
    activeFileName
}: OL001ExcelViewProps) {
    ...
    const [reportData, setReportData] = useState<OL001JsonData | undefined>(
        initialData
    );
        ...
        if (!isLoading && data) {
            ...
            toast.error(
                errors.details?.response?.data?.error ||
                    "Failed to fetch OL001 JSON view"
            );
        }
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="mt-2 text-2xl font-bold text-dark dark:text-white">
                            Collateralized Properties Acquired Last 18 Months
                            (OL001)
                        </h1>
                        ...
                        <table className="w-full border-collapse text-left text-xs font-normal">
                            <thead>
                                <tr className="border-b border-stroke bg-gray-100 text-center font-mono text-[11px] font-semibold text-gray-600 dark:border-dark-3 dark:bg-dark-2 dark:text-gray-300">
                                    ...
                                    {COL_LETTERS.map((letter) => (
                                        <th
                                            key={letter}
                                            className="min-w-[130px] border-r border-stroke py-1.5 dark:border-dark-3"
                                        >
                                            {letter}
                                        </th>
                                    ))}
                            ...
                            <tbody>
                                {filteredRows.map((row) => (
                                    ...
                                    >
                                        ...
                                        <td
                                            ...
                                            className={cn(
                                                "cursor-pointer border-r border-stroke p-2 font-medium text-dark dark:border-dark-3 dark:text-white",
                                                selectedCell?.cellRef ===
                                                    `B${row.rowExcelNum}` &&
                                                    "bg-emerald-500/20 font-bold ring-2 ring-emerald-500 ring-inset"
                                            )}
                                        >
                                            {row.borrowerName}
                                        </td>
                                        ...
                                        <td
                                            ...
                                            className={cn(
                                                "cursor-pointer border-r border-stroke p-2 text-right font-mono dark:border-dark-3",
                                                selectedCell?.cellRef ===
                                                    `C${row.rowExcelNum}` &&
                                                    "bg-emerald-500/20 font-bold ring-2 ring-emerald-500 ring-inset"
                                            )}
                                        ...
                                        <td
                                            ...
                                            className={cn(
                                                "cursor-pointer border-r border-stroke p-2 dark:border-dark-3",
                                                selectedCell?.cellRef ===
                                                    `E${row.rowExcelNum}` &&
                                                    "bg-emerald-500/20 font-bold ring-2 ring-emerald-500 ring-inset"
                                            )}
                                ...
                                <tr className="border-t-2 border-stroke bg-gray-100 font-bold text-dark dark:border-dark-3 dark:bg-dark-2 dark:text-white">
                                    ...
                                    <td className="border-r border-stroke p-2 text-center dark:border-dark-3">
                                        -
                                    </td>
                                    <td className="border-r border-stroke p-2 text-center dark:border-dark-3">
                                        -
                ...
                <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark">
                    <div className="mb-4 flex items-center justify-between">
                        <h2 className="text-lg font-bold text-dark dark:text-white">
                            Raw JSON Payload ({borrowerRows.length} Dynamic
                            Items)
                        </h2>
                        <button
                            onClick={() => {
