...
const ITEMS_CONFIG = [
    ...
    },
    {
        code: "107_00007",
        rowNum: 22,
        desc: "Total capital & reserves",
        indent: 0,
        isTotal: true
    }
];

export function MK001ExcelView({
    initialData,
    activeFileName
}: MK001ExcelViewProps) {
    ...
    const [reportData, setReportData] = useState<MK001JsonData | undefined>(
        initialData
    );
        ...
        if (!isLoading && data) {
            ...
            toast.error(
                errors.details?.response?.data?.error ||
                    "Failed to fetch MK001 JSON view"
            );
        }
    ...
    const filteredItems = ITEMS_CONFIG.filter(
        (i) =>
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-4 dark:border-emerald-500/30">
                        ...
                        <span className="text-xs text-gray-500">
                            Code: 107_00001 (In Millions Birr)
                        </span>
                    </div>
                        ...
                        <table className="w-full border-collapse text-left text-xs font-normal">
                            <thead>
                                <tr className="border-b border-stroke bg-gray-100 text-center font-mono text-[11px] font-semibold text-gray-600 dark:border-dark-3 dark:bg-dark-2 dark:text-gray-300">
                                    ...
                                    <th className="min-w-[300px] border-r border-stroke py-1.5 dark:border-dark-3">
                                        B
                                    </th>
                                </tr>
                                <tr className="border-b border-stroke bg-gray-200 font-semibold text-dark dark:border-dark-3 dark:bg-dark-3 dark:text-white">
                                    ...
                                    <th className="border-r border-stroke p-2 dark:border-dark-3">
                                        Particulars (In Millions of Birr)
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                            ...
                                            <td className="border-r border-stroke p-2 dark:border-dark-3">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span
                                                        ...
                                                        className={cn(
                                                            "cursor-pointer rounded px-3 py-1 font-mono transition",
                                                            isSelected
                                                                ? "bg-emerald-500/20 font-bold text-emerald-900 ring-2 ring-emerald-500 dark:text-emerald-200"
                ...
                <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark">
                    <div className="mb-4 flex items-center justify-between">
                        <h2 className="text-lg font-bold text-dark dark:text-white">
                            Raw JSON Payload (
                            {reportData?.ReturnItemsList?.length || 8} items)
                        </h2>
                        <button
                            onClick={() => {
