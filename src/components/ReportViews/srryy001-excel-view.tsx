...
import {
    SRRYY001_ROW_DESCRIPTIONS,
    SRRYY001_COL_SUFFIXES
} from "@/utils/services/SRRYY001/jsonFormat";
...
export function SRRYY001ExcelView({
    initialData,
    activeFileName
}: SRRYY001ExcelViewProps) {
    ...
    const [reportData, setReportData] = useState<SRRYY001JsonData | undefined>(
        initialData
    );
                        ...
                        <table className="w-full border-collapse text-left text-xs font-normal">
                            ...
                            <tbody>
                                {filteredRows.map((row) => (
                                    <tr
                                        key={row.rowIndex}
                                        className="border-b border-stroke transition hover:bg-gray-50 dark:border-dark-3 dark:hover:bg-dark-2/50"
                                    >
                ...
                <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark">
                    <div className="mb-4 flex items-center justify-between">
                        <h2 className="text-lg font-bold text-dark dark:text-white">
                            Raw JSON Payload (
                            {reportData?.ReturnItemsList?.length || 180} items)
                        </h2>
                        <button
                            onClick={() => {
