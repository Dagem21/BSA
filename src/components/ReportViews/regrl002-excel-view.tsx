...
import {
    ...
    REGRL002_RANGES,
    REGRL002_METRICS
} from "@/utils/services/REGRL002/jsonFormat";
...
export function REGRL002ExcelView({
    initialData,
    activeFileName
}: REGRL002ExcelViewProps) {
    ...
    const [reportData, setReportData] = useState<REGRL002JsonData | undefined>(
        initialData
    );
        ...
        if (!isLoading && data) {
            ...
            toast.error(
                errors.details?.response?.data?.error ||
                    "Failed to fetch REGRL002 JSON view"
            );
        }
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="mt-2 text-2xl font-bold text-dark dark:text-white">
                            Monthly Conventional Loans by Range & Region
                            (REGRL002)
                        </h1>
                ...
                <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark">
                    <div className="mb-4 flex items-center justify-between">
                        <h2 className="text-lg font-bold text-dark dark:text-white">
                            Raw JSON Payload (
                            {reportData?.ReturnItemsList?.length || 2016} items)
                        </h2>
                        <button
                            onClick={() => {
