...
export function Header() {
    ...
    return (
        <header className="sticky top-0 flex items-center justify-between border-b border-stroke bg-white px-4 py-5 shadow-1 md:px-5 2xl:px-10 dark:border-stroke-dark dark:bg-gray-dark">
            <button
